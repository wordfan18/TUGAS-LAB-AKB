    ...
    <ScrollView style={styles.container}>
      ...
      <Image
        source={require('../assets/images/unismuh1.jpg')}
            style={styles.image}
            resizeMode="cover"
            onLoad={() => console.log('✅ Unismuh1.jpg berhasil dimuat!')}
            onError={(error) => {
              console.log('❌ Gagal memuat unismuh1.jpg:', error);
            }}
          />
      ...
      <View style={styles.section}>
        <View style={styles.imageContainer}>
          <Image
            ...
            style={styles.image}
            resizeMode="cover"
            onLoad={() => console.log('✅ Unismuh2.jpg berhasil dimuat!')}
            onError={(error) => {
              console.log('❌ Gagal memuat unismuh2.jpg:', error);
            }}
          />
          <View style={styles.imageOverlay}>
